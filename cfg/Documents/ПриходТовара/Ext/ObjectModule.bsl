...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Для каждого ТекСтрокаТовары Из Товары Цикл
		...
		//++ task04 //-   
		_Коэффициент = ТекСтрокаТовары.ЕдиницаИзмерения.ЗначениеВБазовойЕдиницеИзмерения;
        Движение.Количество = ТекСтрокаТовары.Количество * ?(_Коэффициент = 0, 1, _Коэффициент);
		// task04 //
	КонецЦикла;
